...
## 
##	install_cosbench.sh
##	1, install apache server on driver nodes, update /etc/hosts, remove default admin confidential 
##	2, install COSBENCH on all driver nodes, 
##	3, Check connectivity between controller and all driver nodes
##
################################################################
...
ssh root@$1 -x "scp root@COSBENCH_CONTROLLER:/dan/host-file/dirver$1.host /etc/hosts"
